...
if ($_SESSION['auth_admin'] == 'yes_auth') {
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Homepage</a> / <a href='items.php'>Edit</a> / <a>Items Error</a> ";
    ...
    if ($_POST['submit_save']) {
                ...
                $_SESSION['message'] = '<p id="form-success">Successfully changed the items!</p>';
