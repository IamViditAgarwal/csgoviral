...
$_SESSION['urlpage'] = " <a href='index.php'>Homepage</a> / <a>Cases</a>";
...
?>
<span class="h2class"><button type="button" class="btn btn-success" onclick="javascript:window.location='add_cases.php'">Add case</button> <span class="badge bg-theme"><b><?php echo $all_count_rez; ?></b></span>
...
echo '<div class="col-sm-6 col-md-3"><div class="visotaDiva">
                                        <div class="thumbnail">  <img src="'.$img_path.'" width="150" height="150" "/>
                                            ...
                                            <div class="caption"><h3>'.$row["title"].'</h3>
                                                ...
                                                <p><a  role="button" class="btn btn-primary" href="edit_cases.php?id='.$row["id"].'">Edit</a>  <a role="button" class="btn btn-danger" href="cases.php?'.$url.'id='.$row['id'].'&action=delete" class="delete">Delete</a></div>
                                        </div></div></div>
                                    ';
