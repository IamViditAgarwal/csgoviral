...
if ($_SESSION['auth_admin'] == 'yes_auth') {
    ...
    $_SESSION['urlpage'] = "<a href='http://domain.com/'>Site</a> / <a href='index.php'>Homepage</a> / <a href='faq.php'>FAQ</a> / <a>Adding a question</a> ";
    ...
    if ($_POST['submit_add']) {
		...
		'".$_POST["form_description"]."'
         ...
         $_SESSION['message'] = '<p id="form-success">Question added successfully!</p>';
    }
    ?>
<!DOCTYPE html>
<html lang="en">
                                                    ...
                                                    <div class="row">
                                                       <div class="form-group">
                                                        <label for="inputMessage" class="control-label">
                                                           The answer to the question</label><textarea rows="5" class="form-control" name="form_description"></textarea></div> 
                                                       </div> 
                                                </div>
                                                <div class="form-actions text-right pal">
                                                     <input id="submit_form" type="submit" name="submit_add" class="btn btn-primary" value="Add question"/>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
