...
$cdt = "Table_".$_SESSION["steamid"]."_".$_GET['withdraw'] ;  //left over skin case
...
$url = "127.0.0.1:8000/?req=bot&partner=".$_SESSION['steamid']."&mode=withdrawLeftCase&CaseId=".$_GET['withdraw']."&tradeUrl=".urlencode($tradeUrl).""; 
...
if ($hold_result->num_rows > 0)
{
	...
	//output hold rows from db[now only delete]
	 ...
	 {
	 	if(!(strcmp($row_hst["case_item_image"] , $sw)==0))
	 	{
