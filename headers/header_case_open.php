					    ...
					    <?php
							if(!isset($_SESSION['steamid'])) {
								...
								else 
								{
								     ...
								     echo '      <div style="position: absolute; top: 1px; left: 1px; z-index: 1001; margin-left:-8px;
								    margin-top:-5px;">
								                ...
								                ';
								            echo   " <div style='color: white; float: left; font-size: 18px; font-weight: 400; letter-spacing: 1px; max-width:160px; overflow:hidden ; max-height:25px;   margin-top: -55px; margin-left: 65px;' class='fav_font'><a id='link_profile' href='../profile.php'  title='Go to profile page !' style='text-decoration :none  ;' class='fav_font'>".$steamprofile['personaname']."</a></div>";
