								...
								//{		
										...
										foreach ($inventoryItem as $itemName => $itemValue) {
												...
												{	
													...
													else if( (strpos($itemValue, "Hydra Gloves",0 ) !== false ) || (strpos($itemValue, "Specialist Gloves",0 ) !== false ) || (strpos($itemValue, "Sport Gloves",0 ) !== false ) ||(strpos($itemValue, "Hand Wraps",0 ) !== false ) ||(strpos($itemValue, "Moto Gloves",0 ) !== false ) ||(strpos($itemValue, "Driver Gloves",0 ) !== false ) ||(strpos($itemValue, "Bloodhound Gloves",0 ) !== false ) )
													{
														//means contain item
													...
													$inventoryTable.='<div  id="inventory_item_number_'.$col_count.'"  '.$cc.'       onclick="addItem(\''.$next_item.'\',\''.$weapon_name[0].'\',\''.$skin_name.'\',\''.$exterior.'\',\''.$rarity.'\',\'inventory_item_number_'.$col_count.'\', \''.$tt.'\' )"   >' ;
...
*/
					...
					if($col_count==0)
					{
						...
						echo '<div type="error" class="fav_font" style="width:50%; height:auto;  margin:0 auto; left:0; right:0; font-size : 18px; margin-top:10px; padding-top:5px; padding-bottom:10px; color :#7b7b7b;">No Gloves Found!</div>';
						echo "</div>" ;
					}
